...
/////////////////
const BotName = 'JARVIS BY YOVI '; 
const instagram = 'https://www.instagram.com/xenxasin/'; 
const telegram = 'https://t.me/yovi'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'https://www.youtube.com/channel/UCIxIouO3CCd5zJfYo7Ogiyw';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@xenxasin')
